...
def setup(args):
    ...
    """
    cfg = get_cfg()
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/RetinaNet_Res101/config/RetinaNet_101-PCB.yaml")
    ...
    #cfg.MODEL.WEIGHTS = "/home/ps/DiskA/project/GZY1/result/101/PCB/model_final.pth"
