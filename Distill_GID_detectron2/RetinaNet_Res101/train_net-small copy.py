...
def setup(args):
    ...
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/RetinaNet_Res101/config/RetinaNet_101-small.yaml")
    ...
    cfg.MODEL.WEIGHTS = "/home/ps/DiskA/project/GZY1/result/101/small/model_0000260.pth"
    cfg.INPUT.MIN_SIZE_TRAIN_SAMPLING = 'range'
    cfg.SOLVER.BASE_LR = 0.002  # initial learning rate
    cfg.SOLVER.MOMENTUM = 0.9  # optimizer
    cfg.SOLVER.WEIGHT_DECAY = 0.0001

    cfg.SOLVER.GAMMA = 0.01  # learning rate decay rates
