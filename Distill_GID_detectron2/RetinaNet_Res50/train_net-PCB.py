...
def setup(args):
    ...
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/RetinaNet_Res50/config/RetinaNet-50-PCB.yaml")
    ...
    cfg.MODEL.WEIGHTS = "/home/ps/DiskA/project/GZY1/result/50/PCB/model_0001247.pth"
