...
def setup(args):
    ...
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/RetinaNet_Res18/config/Retinanet-18-small.yaml")
    ...
    #cfg.MODEL.WEIGHTS = "/home/ps/DiskA/project/GZY1/result/18/small/model_final.pth"
    cfg.SOLVER.BASE_LR = 0.0001  # initial learning rate
