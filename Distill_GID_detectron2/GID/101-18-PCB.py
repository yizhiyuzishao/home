...
def setup(args):
    ...
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/GID/config/Distill_T_res101_S_res18-PCB.yaml")
    ...
    cfg.DISTILL.STUDENT_CFG.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/home/ps/DiskA/project/GZY1/result/18/PCB/model_final.pth") 
    
    cfg.DISTILL.TEACHER_CFG.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/home/ps/DiskA/project/GZY1/result/101/PCB/model_final.pth")
