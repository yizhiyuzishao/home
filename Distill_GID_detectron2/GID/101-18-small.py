...
def setup(args):
    ...
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/GID/config/Distill_T_res101_S_res18-small.yaml")
    ...
    cfg.DISTILL.STUDENT_CFG.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/home/ps/DiskA/project/GZY1/result/18/small/model_final.pth") 
