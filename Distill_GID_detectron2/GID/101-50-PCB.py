...
def setup(args):
    ...
    cfg.merge_from_file("/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/GID/config/DistillT_Res101_S_Res50_PCB.yaml")
    ...
    cfg.DISTILL.STUDENT_CFG.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/home/ps/DiskA/project/GZY1/result/50/PCB/model_final.pth") 
