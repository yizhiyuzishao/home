...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", required=True, help="JSON file produced by the model",default="/home/ps/DiskA/project/GZY1/Distill_GID_detectron2/RetinaNet_Res101/output_1x_smooth_l1/metrics.json")
    parser.add_argument("--output", required=True, help="output directory",default="/home/ps/DiskA/project/GZY1/Distill_GID_detectron2")
    parser.add_argument("--dataset", help="name of the dataset", default="coco_val")
